...
| `ATLASCLOUD_API_KEY` | No | — | Optional server-only Atlas Cloud credential for Trabalho layerization in workspaces with an active `layer_editor_v1` entitlement. Missing disables the action; never expose it to the browser. |
