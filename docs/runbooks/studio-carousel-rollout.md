...
1. **Keep `0` until both proofs exist**
   ...
   **2026-08-31:** product owner waived the nine-deck human gate and then
   enabled `STUDIO_CAROUSEL_ROLLOUT_PERCENT=100` without that proof. The
   template stays `pending_human_review`; this is not a validator PASS.
