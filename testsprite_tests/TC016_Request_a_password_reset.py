...
async def run_test():
    ...
    try:
        ...
        # -> Accept the cookie banner and then open the Forgot Password page by clicking the 'Forgot password?' link.
        ...
        # -> Fill the email field with dev-admin@adscale.local and submit the reset request by clicking the send-reset button.
