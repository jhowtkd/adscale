...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/library and then verify whether workspace library assets are visible (look for asset list/cards or the seeded asset names).
        ...
        # -> Accept the cookie banner, enter dev-admin@adscale.local and DevAdmin123! into the login form, and submit Sign in to authenticate.
