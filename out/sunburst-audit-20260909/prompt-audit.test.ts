...
} from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/brand-training/contracts";
import type {
  CreativeLevel,
  CreativeWorkIdentityAssetSnapshot,
  CreativeWorkIdentitySnapshot,
  SocialPostCopy,
} from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/contracts";

import { buildCreativeWorkPrompt, buildSocialPostPrompt, type BuildCreativeWorkPromptInput } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/prompt";
import { CREATIVE_LEVEL_DIRECTIONS } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/ai/creative-level-direction";
import type { CreativeWorkFactPack } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/contracts";
import type { CreativeWorkReferenceSlot } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/reference-plan";
...
import { buildCarouselSlidePrompt } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/prompt";
import type { CarouselDeckPlanV1, CarouselVisualContractV1 } from "/Users/jhonatan/Repos/ADScale_2/.worktrees/sunburst-engine/app/src/server/creative-work/carousel-contracts";
...
it("audit: delivers visual revision instruction with deterministic typography", () => {
 const instruction = "Troque somente o fundo por formas triangulares azul-marinho";
 const prompt = buildCreativeWorkPrompt(creativeWorkPromptInput({ mode: "creative_revision", textExecution: "deterministic", revisionInstruction: instruction, references: [slot("revision", "peca-aprovada.png")] }));
