CREATE TABLE IF NOT EXISTS "adscale_app"."workspace_entitlements" (
...
CREATE TABLE IF NOT EXISTS "adscale_app"."beta_access_redemptions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_entitlements_workspace_id_idx" ON "adscale_app"."workspace_entitlements" USING btree ("workspace_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_entitlements_kind_status_idx" ON "adscale_app"."workspace_entitlements" USING btree ("kind", "status");
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "workspace_entitlements_workspace_kind_uidx" ON "adscale_app"."workspace_entitlements" USING btree ("workspace_id", "kind");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beta_access_redemptions_user_id_idx" ON "adscale_app"."beta_access_redemptions" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beta_access_redemptions_entitlement_id_idx" ON "adscale_app"."beta_access_redemptions" USING btree ("entitlement_id");
