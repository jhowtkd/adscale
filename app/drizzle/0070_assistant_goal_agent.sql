...
CREATE TABLE IF NOT EXISTS "adscale_app"."assistant_goal_runs" (
  ...
  "started_by_user_id" text NOT NULL REFERENCES "adscale_app"."user"("id") ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "adscale_app"."assistant_artifact_annotations" (
  ...
  "created_by_user_id" text NOT NULL REFERENCES "adscale_app"."user"("id") ON DELETE CASCADE,
  "created_at" timestamp NOT NULL DEFAULT now(),
  "updated_at" timestamp NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS "adscale_app"."client_corpus_consents" (
  ...
  "reviewed_by_user_id" text NOT NULL REFERENCES "adscale_app"."user"("id") ON DELETE CASCADE,
