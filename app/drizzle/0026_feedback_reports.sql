...
--> statement-breakpoint
CREATE INDEX "feedback_reports_workspace_id_idx" ON "adscale_app"."feedback_reports" USING btree ("workspace_id");
--> statement-breakpoint
CREATE INDEX "feedback_reports_user_id_idx" ON "adscale_app"."feedback_reports" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "feedback_reports_status_idx" ON "adscale_app"."feedback_reports" USING btree ("status");
--> statement-breakpoint
CREATE INDEX "feedback_reports_created_at_idx" ON "adscale_app"."feedback_reports" USING btree ("created_at");
--> statement-breakpoint
CREATE INDEX "feedback_reports_campaign_id_idx" ON "adscale_app"."feedback_reports" USING btree ("campaign_id");
--> statement-breakpoint
CREATE INDEX "feedback_reports_derivation_id_idx" ON "adscale_app"."feedback_reports" USING btree ("derivation_id");
