            ...
            {ALL_FORMATS.map((format) => {
              ...
              return (
                ...
                >
                  <input
                    type="checkbox"
                    className="size-4 rounded border-[var(--border-dim)] text-[var(--selection-text)] focus:ring-[var(--focus-ring)]"
                  ...
                  {isSource && (
                    <span className="text-xs text-[var(--success-text)] font-medium">
                      {t("ready")}
                    </span>
                  )}
                </label>
