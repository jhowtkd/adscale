...
vi.mock("next-intl", () => ({
  useTranslations: () => (key: string, values?: { title?: string }) => ({
    add: "Adicionar referência", title: "Referências da marca", loading: "Carregando inspirações", loadFailed: "Não foi possível carregar as inspirações.", retry: "Tentar novamente", empty: "Nenhuma inspiração disponível ainda.", attachFailed: "Não foi possível adicionar a referência. Tente novamente.", useForStyle: "Usar para mudar estilo", "origin.curated": "Seleção ADScale", "origin.approved_work": "Trabalho aprovado", "origin.template": "Template",
