# Requirements Archive: v13.5 Assistente Conversacional de Ações
...
- [x] **EXEC-02**: Long-running actions use existing pipeline/Inngest job behavior and show status in the assistant thread. *(jobRef mirrored on action-card payload as of audit fix 2026-06-25)*
...
- [~] **EXEC-04**: User can complete the happy path from loose idea to final package: select/create client, create campaign draft, satisfy the relevant action contract, generate preview, approve direction, generate batch, review, and create delivery package. *(Authenticated Playwright shell covered; full live Inngest/OpenAI lifecycle is human verification.)*
...
| EXEC-02 | Phase 178 | Complete (jobRef payload fix 2026-06-25) |
| EXEC-03 | Phase 183 | Complete |
| EXEC-04 | Phase 183 | Partial — E2E shell; live lifecycle human verify |

**Coverage:**
- v13.5 requirements: 21 total
- Mapped to phases: 21
- Satisfied: 20
- Partial: 1 (EXEC-04 live lifecycle)
- Unmapped: 0

---
*Requirements defined: 2026-06-25*
*Last updated: 2026-06-25 after v13.5 audit closure fixes*
