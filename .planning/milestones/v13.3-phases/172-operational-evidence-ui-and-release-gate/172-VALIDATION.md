...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 172-01-01 | 01 | 1 | ALERT-01, ALERT-03 | component | `cd app && npm test -- --run src/components/feedback/FactualAlertsPanel.test.tsx` | yes | green |
| 172-01-02 | 01 | 1 | ALERT-02, ALERT-03 | component | `cd app && npm test -- --run src/components/feedback/FactualAlertsPanel.test.tsx` | yes | green |
| 172-02-01 | 02 | 2 | ALERT-01 | integration | `cd app && npm test -- --run src/components/feedback/HumanQualityCorpusPanel.test.tsx` | yes | green |
...
- [x] Wave 0 covers existing API before UI tests
