...
| 171 | Persistent Product Trust Baseline | 1/4 | In Progress|  |
...
- [ ] 171-02-PLAN.md — Profile hook and ProfileTab API wiring
- [ ] 171-03-PLAN.md — Workspace hook and WorkspaceTab API wiring
