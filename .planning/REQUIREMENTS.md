...
- [x] **SOURCE-05**: Release evidence reports both technical status and operational evidence status for the active brand sample.
...
- [x] **BRAND-03**: Navigation, labels and call-to-action copy use consistent product language across campaign creation, generation, review and settings.
...
- [x] **TRUST-03**: Disabled settings tabs are either backed by real APIs or hidden behind honest unavailable states.
- [x] **TRUST-04**: Settings save/error/loading states are deterministic and tested.
- [x] **TRUST-05**: Existing brand kit, team, billing and privacy settings continue to work after profile/workspace persistence changes.
...
- [x] **ALERT-04**: The release checklist covers the new decision, source, brand, settings and alert surfaces.
