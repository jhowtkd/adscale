...
Transformar a infraestrutura v12.7 do `Olhar ADScale` em uma operacao real de calibracao Cenbrap: rodar campanhas reais, capturar decisoes do Jhonatan, medir acordo/desacordo e atualizar a evidencia sem claims falsos.

**Starting point:** v12.7 fechou como `tech_debt`: implementacao tecnica concluida, mas `142-CENBRAP-CALIBRATION.json` live nao existe, `evaluatedCampaignCount=0`, `humanDecisionCount=0`, contact sheet esta em template e `agreementRate` foi corretamente withheld.

**In scope:** conexao com ambiente que tem campanhas Cenbrap, calibracao live, contact sheet preenchido, decisoes humanas `entra/quase/nao_entra`, triagem de mismatches, refresh de evidencia v12.7/v12.8 e playbook operacional repetivel.
...
| JUDGE-04 | Phase 144 | Pending |
| CLAIM-01 | Phase 145 | Pending |
| CLAIM-02 | Phase 145 | Pending |
| CLAIM-03 | Phase 145 | Pending |
| CLAIM-04 | Phase 145 | Pending |

**Coverage:**
- v12.8 requirements: 12 total
- Mapped to phases: 12
- Unmapped: 0
