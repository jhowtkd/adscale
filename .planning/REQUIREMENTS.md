...
- [x] **EVIDENCE-04**: Fixture-only brands always carry explicit caveat in profile and panel UI.
...
- [x] **GLOBAL-05**: Global promotion does not bypass per-brand isolation in prompt application.
...
| EVIDENCE-04 | Phase 166 | Complete |
