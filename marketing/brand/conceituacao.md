# Pacote Conceitual ADScale — v0

> **Status:** Conceituação inicial. Producao de copy/execucao segue congelada ate esse framework ser aprovado.
> **Owner:** Jhonatan (founder).
> **Data:** 2026-06-24.
> **Substitui:** `tom-de-voz.md` (v1) e `mensagens-chave.md` (v1) como referencia conceitual. Ver secao "Migracao de v1" no fim.

---

## Indice

1. [Posicionamento](#parte-1--posicionamento)
2. [Narrativa](#parte-2--narrativa)
3. [Tom de voz](#parte-3--tom-de-voz)
4. [Identidade verbal](#parte-4--identidade-verbal)
5. [Como esse pacote conecta com a execucao](#parte-5--como-esse-pacote-conecta-com-a-execucao)
6. [Migracao de v1](#parte-6--migracao-de-v1)
...
**Concorrentes diretos (geracao com IA):**
- **AdCreative.ai** — gera criativos com IA. Posiciona-se como "AI creative generator".
- **Pencil** — gera + preve performance. Posiciona-se como "AI creative platform".
...
- **Canva** — ferramenta de design para todos. Nao e "escala", e "producao manual".
...
**ICP raiz (copy universal fala com esse grupo):**
Qualquer pessoa ou time que produz criativos para anuncios pagos (Meta, TikTok, Google) e sente que o gargalo de producao esta impedindo de escalar.

**Sub-ICP (exemplos rotativos, sem hierarquia):**
- Designer freelancer que produz sozinho e quer dobrar o output sem dobrar as horas.
- Time interno de marketing (ate 5 pessoas) que esta travado em volume porque nao conseguem contratar mais um designer.
- Agencia de marketing (5-30 pessoas) com 5+ clientes ativos que precisa escalar sem inflar headcount.
- Empresa produzindo pra si (socio + designer interno em e-commerce, SaaS, infoproduto).
...
### 1.5 Escala significa o que

A copy precisa cobrir tres dimensoes (definida na rodada anterior de conceituacao):

- **Volume** — produzir mais criativos por semana (8 → 50 → 200).
- **Velocidade** — produzir criativos em menos tempo (3 dias → 20 min).
- **Variedade** — testar mais angulos por campanha (2 → 10).

Sem destaque a uma dimensao "principal". As tres juntas dao o sentido de "escala".

---

## Parte 2 — Narrativa

### 2.1 Origem (por que ADScale existe)

Jhonatan, founder tecnico, trabalhava com criacao de criativos pra ads — seja pra clientes, seja pra si. Em algum momento bateu: "Eu passo mais tempo gerando variacoes do que pensando no briefing."
...
O mercado de performance marketing tem uma doenca cronica: a **escada do operator**.

- Designer junior comeca fazendo uma peca por dia.
- Com experiencia, aprende a fazer mais rapido.
- Mas "mais rapido" tem limite — chega em 3-5 pecas/dia, satura.
- Pra escalar, a agencia contrata +1 designer. Custo: R$ 5-8k/mes.
- Ou entao sobrecarrega o time atual. Custo: burnout, qualidade cai, cliente reclama.
...
Tres adjetivos guiam tudo:

| Adjetivo | O que significa | O que **nao** e |
|----------|-----------------|------------------|
| **Expert** | Mostra dominio tecnico do problema. Cita casos, numeros, modelos. | Nao e pedante, nao e coach, nao e "guru". |
| **Fast** | Respeita o tempo do leitor. Copy curta, sem enrolacao, sem filler. | Nao e raso, nao e clickbait, nao e "TL;DR" no fim. |
| **Creative** | A forma acompanha o conteudo. Visual bem feito, copy com ritmo. | Nao e "diferentao", nao e estetica pela estetica, nao e performatico. |

### 3.2 Persona verbal: o founder-cientista

A marca fala como um **founder tecnico fala com outro profissional de marketing que produz criativos** — seja ele dono de agencia, designer freelancer, gestor de trafego, ou head de marketing.

A persona e a de um **cientista num laboratorio** — observa, experimenta, documenta, compartilha resultados (positivos ou negativos). Nao e coach, nao e guru, nao e marqueteiro. E o founder que constroi em publico e mostra o metodo.

**Ajustes vs. v1 (tom-de-voz.md):**
- **Antes:** "fala como founder tecnico fala com outro **founder de agencia**".
- **Agora:** fala com qualquer profissional que produz criativos pra performance (decisor ou operacional, agencia ou nao).

**Humor:** obrigatorio, mas em camada fina (humor britanico, deadpan). Nunca em piiada ou meme. Nunca como substituto da tecnica.

### 3.3 Principios de comunicacao

1. **Direto > bonito.** Frases curtas, verbo no imperativo, sem rodeio.
...
#### 1. Provocacao → argumento → prova
> "Times que escalam sem contratar +1 designer estao fazendo isso. Funciona por causa de [X]. Caso: [Y]."

#### 2. Bastidor → licao → CTA suave
> "Essa semana no ADScale: [decisao tecnica]. O que aprendi: [X]. Se voce ta construindo criativos pra ads, talvez te ajude: [link]."

#### 3. Mito → realidade → como
> "Mito: IA mata o designer. Realidade: IA mata o retrabalho. Como: [3 passos]."

#### 4. Lista numerada com gancho
> "5 coisas que toda pessoa que escala criativo faz e que custam 3x mais caro do que precisa. 1. ..."
...
## Parte 4 — Identidade verbal

### 4.1 Vocabulario canonico
...
- Hook / angulo / CTA
- Workspace
- Throughput (de producao)
- Batch (modelo mental: 1 base → dezenas)
- ROAS / CPA (quando relevante)
- Stack de marketing
- Workflow
- Build in public (quando aplicavel)
- Laboratorio / lab / experimento / protocolo / hipotese / grupo de controle / grupo experimental / variavel / anomalia / significancia estatistica / double-blind / lab notebook / paper / dados / resultado (vocabulario da persona founder-cientista)

### 4.2 Vocabulario que evitamos

| ❌ Evitar | ✅ Substituir por |
|-----------|-------------------|
| "Revolucionario" | "10x" ou numero especifico |
| "Disruptivo" | (nao usamos, esta queimado) |
| "IA magica" | "modelo de geracao" ou nomeamos o modelo |
| "Game-changer" | (nao usamos) |
| "Ecossistema" | "ferramenta" ou "stack" |
| "Sinergia" | (riscar) |
...
- "E com grande satisfacao que..."
- "Nossa missao e..."
- "Acreditamos que..." (a menos que seja provocacao)
...
> "Estamos revolucionando a forma como agencias criam anuncios! Com nossa plataforma inovadora e ecossistema de IA, voce alcanca resultados disruptivos em tempo recorde. ✨🚀"

> "IA que faz tudo sozinha — voce so precisa clicar e a magica acontece!"

> "Acabou a era do designer. A IA substituiu."

---

## Parte 5 — Como esse pacote conecta com a execucao

Esse pacote conceitual **nao e copy de execucao**. E o **framework** que toda copy futura passa por.
...
5. A copy respeita a estrutura argumentativa do canal (Lab Notes pra Reels, EN pra LinkedIn, etc.)?

Se a copy passa nesse checklist, ela esta alinhada com a marca. Se nao passa, ou ajustamos a copy ou revisitamos o framework.

---

## Parte 6 — Migracao de v1

Os arquivos abaixo ficam **mantidos como referencia historica** mas nao sao mais a fonte canonica. Esta secao documenta o que mudou entre v1 e v0 deste pacote.

### `marketing/brand/tom-de-voz.md` (v1, 2026-06-23)

**O que foi mantido:**
- Personalidade (Expert, Fast, Creative) — preservada.
- Principios de comunicacao (Direto, Tecnico, Confianca, Pessoal, Bilingue) — preservados.
- Estrutura de post (4 esqueletos) — preservada.
- Voz por canal — preservada.
- Vocabulario (palavras que usamos/evitamos) — preservado e expandido.
- Formato de Reels Lab Notes como default — preservado.

**O que mudou:**
- ICP canonico: sai "founder de agencia", entra ICP amplo (qualquer pessoa/time que produz criativos pra ads).
...
- `marketing/copy/sales-page.md`
- `marketing/2026-Q3/plano-marketing-completo.md`
- `marketing/2026-Q3/sequencia-emails.md`
- `marketing/2026-Q3/producao-reels-1.md`
- `marketing/2026-Q3/roteiros-semana-1.md`
- `marketing/2026-Q3/kanban/01-ideias.md`, `02-briefs.md`, `03-prontos.md`, `04-publicados.md`
- `marketing/social-media/plano-redes-sociais.md`
- `marketing/social-media/canais/youtube.md`, `instagram.md`, `linkedin.md`

Nao mexer agora (producao congelada). Apenas registrar.

---

*Mantido em `marketing/brand/` · PT-BR · Versao 0 (conceituacao inicial) · 2026-06-24*