# Brand — Identidade verbal

> Tom de voz, pilares de mensagem, palavras permitidas e proibidas.
> Referência obrigatória antes de escrever qualquer copy.

## ⚠️ Fonte canônica (a partir de 2026-06-24)
...
- **Produção de copy/execução:** congelada até `conceituacao.md` ser aprovado.
- **Próximo passo:** revisar conceituacao.md, ajustar se preciso, e só então descongelar produção.

---

*Subpasta de `marketing/` · PT-BR · Última atualização: 2026-06-24*