...
Linha 2–3: continuação do gancho ou contradição que puxa o "ver mais".
Linha 4–N: desenvolvimento em blocos curtos (linha em branco entre blocos).
Penúltima linha: virada ou conclusão.
...
- **Nunca colocar link no corpo** (LinkedIn reduz alcance). Link nos **comentários**.
...
```
Linha 1: gancho
Linha 2–4: desenvolvimento em 1 ideia
...
| Atividade | Tempo |
|-----------|-------|
| Comentar em 5–10 posts de donos de agência e referências do nicho | 15 min |
| Aceitar pedidos de conexão de decisores | 5 min |
